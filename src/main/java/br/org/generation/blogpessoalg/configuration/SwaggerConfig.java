package br.org.generation.blogpessoalg.configuration;
...
public class SwaggerConfig {
	...
	public Docket api() {
		...
		return new Docket(DocumentationType.SWAGGER_2)
			...
			.basePackage("br.org.generation.blogpessoalg.controller"))
	...
	private static Contact contact() {
		...
		return new Contact("Gustavo Muniz", "https://github.com/gumunizs", "gustavomunizsantos@gmail.com");
